...
export default function ConferenceInfo({ language }: ConferenceInfoProps) {
  ...
  const content = {
    en: {
      ...
      motivationText:
        "Driven by the rapid transformation of global education, there is an urgent need to evaluate how Islamic academic structures can leverage AI to enhance research quality while preserving the integrity of Sharia methodologies.",
    ...
    ar: {
      ...
      motivation: "الدوافع",
      motivationText:
        "انطلاقاً من التحول السريع للتعليم العالمي، هناك حاجة ملحة لتقييم كيفية استفادة الهياكل الأكاديمية الإسلامية من الذكاء الاصطناعي لتعزيز جودة البحث مع الحفاظ على نزاهة المنهجيات الشرعية.",
  ...
  const objectives = [
    {
      en: "Diagnose the reality of Sharia curricula under digital transformation",
      ar: "تشخيص واقع المناهج الشرعية في ظل التحول الرقمي",
    },
    {
      en: "Analyze AI’s impact on Islamic scientific research",
      ar: "تحليل أثر الذكاء الاصطناعي على البحث العلمي الإسلامي",
    },
    {
      en: "Promote awareness of AI integration in Islamic education",
      ar: "تعزيز الوعي بدمج الذكاء الاصطناعي في التعليم الإسلامي",
    },
    {
      en: "Discuss ethical and Sharia challenges of AI usage",
      ar: "مناقشة التحديات الأخلاقية والشرعية لاستخدام الذكاء الاصطناعي",
    },
    {
      en: "Highlight successful AI-driven educational models",
      ar: "تسليط الضوء على النماذج التعليمية الناجحة المدعومة بالذكاء الاصطناعي",
    },
    {
      en: "Develop Sharia research methodologies aligned with modern standards",
      ar: "تطوير منهجيات البحث الشرعي بما يتماشى مع المعايير الحديثة",
    },
    {
      en: "Enhance collaboration between Sharia scholars and AI experts",
      ar: "تعزيز التعاون بين علماء الشريعة وخبراء الذكاء الاصطناعي",
    },
    {
      en: "Anticipate the future of Islamic curricula",
      ar: "استشراف مستقبل المناهج الإسلامية",
    },
    {
      en: "Exchange expertise and build academic partnerships",
      ar: "تبادل الخبرات وبناء الشراكات الأكاديمية",
    },
    {
      en: "Produce scientific recommendations to improve Sharia education quality",
      ar: "تقديم توصيات علمية لتحسين جودة التعليم الشرعي",
    },
  ];
  ...
  const targetAudience = [
    {
      en: "Faculty members and researchers",
      ar: "أعضاء هيئة التدريس والباحثون",
    },
    {
      en: "Postgraduate students in Islamic sciences",
      ar: "طلبة الدراسات العليا في العلوم الشرعية",
    },
    { en: "Academic decision-makers", ar: "صناع القرار الأكاديمي" },
    { en: "Curriculum development specialists", ar: "متخصصو تطوير المناهج" },
    {
      en: "AI and educational technology experts",
      ar: "خبراء الذكاء الاصطناعي وتقنيات التعليم",
    },
    {
      en: "Islamic and educational institutions",
      ar: "المؤسسات الإسلامية والتعليمية",
    },
    {
      en: "Publishers and digital educational content developers",
      ar: "الناشرون ومطورو المحتوى التعليمي الرقمي",
    },
  ];
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {objectives.map((obj, index) => (
              <div
                key={index}
                className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-neutral-100 shadow-sm hover:border-accent/30 transition-colors"
              >
